...
exports.FootLockerConnector = void 0;
const StoreConnector_1 = require("../base/StoreConnector");
class FootLockerConnector extends StoreConnector_1.StoreConnector {
    constructor(storeId) {
        super(storeId);
    }
    async fetchOffers(limit = 10) {
...
exports.FootLockerConnector = FootLockerConnector;
